...
- [[daily/lcash/2026-05-29.md]] - Phase 2: 741 picks categorized (170 voids + 571 accent-canon grades); accent-canon mismatch between `_normalize` and `_normalize_name` — see [[concepts/accent-canonicalization-resolver-mismatch]]; M8 25.5%→<1% after Phase 2; overnight regression to 6.36% from unfixed code; code fix commit e72d26e; Phase 1 corruption cascading through `updated_at` filtering — `game_date` scoping needed instead; final re-scope of 55,428 picks (Sessions 10:48, 17:22)
